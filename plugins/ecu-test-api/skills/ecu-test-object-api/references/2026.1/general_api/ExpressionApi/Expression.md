...
- [C Expression ](#ApiClient.Expression)
  - [M Clone ](#ApiClient.Expression.Clone)
...
Return type:  [`Expression`](#ApiClient.Expression "ApiClient.Expression (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
