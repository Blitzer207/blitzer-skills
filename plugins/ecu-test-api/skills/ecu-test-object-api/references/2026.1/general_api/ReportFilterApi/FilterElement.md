...
- [C FilterElement ](#ApiClient.FilterElement)
  - [M Clone ](#ApiClient.FilterElement.Clone)
  - [M GetExpression ](#ApiClient.FilterElement.GetExpression)
...
Return type:  [`FilterElement`](#ApiClient.FilterElement "ApiClient.FilterElement (Python class) — Represents a single filter criteria that can be appended to a report filter group ('AND' and 'OR').")
