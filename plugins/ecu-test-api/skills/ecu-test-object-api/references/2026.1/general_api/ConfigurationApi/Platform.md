...
- [C Platform ](#ApiClient.Platform)
  - [A FailureSimulation ](#ApiClient.Platform.FailureSimulation)
  - [A FunctionAccess ](#ApiClient.Platform.FunctionAccess)
  - [A ModelAccess ](#ApiClient.Platform.ModelAccess)
  - [M Clone ](#ApiClient.Platform.Clone)
...
Return type:  [`FailureSimulationAccess`](FailureSimulationAccess.md#ApiClient.FailureSimulationAccess "ApiClient.FailureSimulationAccess (Python class) — Adds a failure simulation")
...
Return type:  [`FunctionAccess`](FunctionAccess.md#ApiClient.FunctionAccess "ApiClient.FunctionAccess (Python class) — Adds a function to the function access.")
...
Return type:  [`ModelAccess`](ModelAccess.md#ApiClient.ModelAccess "ApiClient.ModelAccess (Python class) — Adds a model")
...
Return type:  [`Platform`](#ApiClient.Platform "ApiClient.Platform (Python class) — Failure Simulation access")
