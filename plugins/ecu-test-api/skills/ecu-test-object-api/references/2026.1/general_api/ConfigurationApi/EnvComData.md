...
EnvComData [ EnvComData ](#)

EnvComData

- [C EnvComData ](#ApiClient.EnvComData)
  - [M Clone ](#ApiClient.EnvComData.Clone)
  - [M GetName ](#ApiClient.EnvComData.GetName)
  - [M Rename ](#ApiClient.EnvComData.Rename)
...
Return type:  [`EnvComData`](#ApiClient.EnvComData "ApiClient.EnvComData (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
...
Rename(*[newEnvironmentCommunicationKey](#ApiClient.EnvComData.Rename.newEnvironmentCommunicationKey "ApiClient.EnvComData.Rename.newEnvironmentCommunicationKey (Python parameter) — New name of the environment communication system")*)[¶](#ApiClient.EnvComData.Rename "Link to this definition")  
Renames the model.

Parameters:  newEnvironmentCommunicationKey : str[¶](#ApiClient.EnvComData.Rename.newEnvironmentCommunicationKey "Permalink to this definition")  
New name of the environment communication system
