...
ParameterSetAnalysisPackage [ ParameterSetAnalysisPackage ](#)

ParameterSetAnalysisPackage

- [C ParameterSetAnalysisPackage ](#ApiClient.ParameterSetAnalysisPackage)
  - [A Attributes ](#ApiClient.ParameterSetAnalysisPackage.Attributes)
  - [A GlobalConstants ](#ApiClient.ParameterSetAnalysisPackage.GlobalConstants)
  - [A Mapping ](#ApiClient.ParameterSetAnalysisPackage.Mapping)
  - [A MappingFiles ](#ApiClient.ParameterSetAnalysisPackage.MappingFiles)
  - [A Parameters ](#ApiClient.ParameterSetAnalysisPackage.Parameters)
  - [M Clone ](#ApiClient.ParameterSetAnalysisPackage.Clone)
  - [M GetIndex ](#ApiClient.ParameterSetAnalysisPackage.GetIndex)
  - [M GetLineNo ](#ApiClient.ParameterSetAnalysisPackage.GetLineNo)
  - [M GetName ](#ApiClient.ParameterSetAnalysisPackage.GetName)
  - [M GetPackage ](#ApiClient.ParameterSetAnalysisPackage.GetPackage)
  - [M GetParent ](#ApiClient.ParameterSetAnalysisPackage.GetParent)
  - [M GetTestCaseId ](#ApiClient.ParameterSetAnalysisPackage.GetTestCaseId)
  - [M GetTestScriptId ](#ApiClient.ParameterSetAnalysisPackage.GetTestScriptId)
  - [M GetType ](#ApiClient.ParameterSetAnalysisPackage.GetType)
  - [M IsEnabled ](#ApiClient.ParameterSetAnalysisPackage.IsEnabled)
  - [M IsReported ](#ApiClient.ParameterSetAnalysisPackage.IsReported)
  - [M RemoveFromProject ](#ApiClient.ParameterSetAnalysisPackage.RemoveFromProject)
  - [M SetEnabled ](#ApiClient.ParameterSetAnalysisPackage.SetEnabled)
  - [M SetName ](#ApiClient.ParameterSetAnalysisPackage.SetName)
  - [M SetReported ](#ApiClient.ParameterSetAnalysisPackage.SetReported)
  - [M SetTestCaseId ](#ApiClient.ParameterSetAnalysisPackage.SetTestCaseId)
  - [M GetPosition ](#ApiClient.ParameterSetAnalysisPackage.GetPosition)
...
Return type:  [`ParameterSetMapping`](ParameterSetMapping.md#ApiClient.ParameterSetMapping "ApiClient.ParameterSetMapping (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
...
Return type:  [`ParameterSetAnalysisPackage`](#ApiClient.ParameterSetAnalysisPackage "ApiClient.ParameterSetAnalysisPackage (Python class) — Returns access to the package attributes definitions specified within the parameter set and the referenced package attribute definition files.")

GetIndex()[¶](#ApiClient.ParameterSetAnalysisPackage.GetIndex "Link to this definition")  
...
GetLineNo()[¶](#ApiClient.ParameterSetAnalysisPackage.GetLineNo "Link to this definition")  
...
Returns:  The referenced package of type [`Package`](../PackageApi/Package.md#ApiClient.Package "ApiClient.Package (Python class) — PackageApi.CreatePackage") or the referenced analysis package of type [`AnalysisPackage`](../PackageApi/AnalysisPackage.md#ApiClient.AnalysisPackage "ApiClient.AnalysisPackage (Python class) — PackageApi.CreateAnalysisPackage")

Return type:  [`PackageBase`](../TraceAnalysisApi/PackageBase.md#ApiClient.PackageBase "ApiClient.PackageBase (Python class) — Returns access to the package attributes definitions specified within the parameter set and the referenced package attribute definition files.")
...
IsReported()[¶](#ApiClient.ParameterSetAnalysisPackage.IsReported "Link to this definition")  
...
SetEnabled(*[state](#ApiClient.ParameterSetAnalysisPackage.SetEnabled.state "ApiClient.ParameterSetAnalysisPackage.SetEnabled.state (Python parameter) — True (=Default) to enable, False to disable the test step.")=`True`*)[¶](#ApiClient.ParameterSetAnalysisPackage.SetEnabled "Link to this definition")  
Enable or disable the test step.

Parameters:  state : bool[¶](#ApiClient.ParameterSetAnalysisPackage.SetEnabled.state "Permalink to this definition")  
True (=Default) to enable, False to disable the test step.

SetName(*[name](#ApiClient.ParameterSetAnalysisPackage.SetName.name "ApiClient.ParameterSetAnalysisPackage.SetName.name (Python parameter) — Name of the component")*)[¶](#ApiClient.ParameterSetAnalysisPackage.SetName "Link to this definition")  
Sets the name of the project component.

Parameters:  name : str[¶](#ApiClient.ParameterSetAnalysisPackage.SetName.name "Permalink to this definition")  
Name of the component

SetReported(*[state](#ApiClient.ParameterSetAnalysisPackage.SetReported.state "ApiClient.ParameterSetAnalysisPackage.SetReported.state (Python parameter) — True (=Default) to enable, False to disable the reporting of the test step.")=`True`*)[¶](#ApiClient.ParameterSetAnalysisPackage.SetReported "Link to this definition")  
...
Parameters:  state : bool[¶](#ApiClient.ParameterSetAnalysisPackage.SetReported.state "Permalink to this definition")  
True (=Default) to enable, False to disable the reporting of the test step.

SetTestCaseId(*[testCaseId](#ApiClient.ParameterSetAnalysisPackage.SetTestCaseId.testCaseId "ApiClient.ParameterSetAnalysisPackage.SetTestCaseId.testCaseId (Python parameter) — Test case id")*)[¶](#ApiClient.ParameterSetAnalysisPackage.SetTestCaseId "Link to this definition")  
Sets the independent test case id of the parameter record.

Parameters:  testCaseId : str[¶](#ApiClient.ParameterSetAnalysisPackage.SetTestCaseId.testCaseId "Permalink to this definition")  
Test case id
...
Deprecated since version 2024.4: Please use method [`GetLineNo`](#ApiClient.ParameterSetAnalysisPackage.GetLineNo "ApiClient.ParameterSetAnalysisPackage.GetLineNo (Python method) — Returns the line number within its project.") instead.
