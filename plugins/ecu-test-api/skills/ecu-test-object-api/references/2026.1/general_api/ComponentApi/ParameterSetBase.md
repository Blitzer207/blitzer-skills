...
- [C ParameterSetBase ](#ApiClient.ParameterSetBase)
  - [A Attributes ](#ApiClient.ParameterSetBase.Attributes)
  - [A GlobalConstants ](#ApiClient.ParameterSetBase.GlobalConstants)
  - [A Mapping ](#ApiClient.ParameterSetBase.Mapping)
  - [A MappingFiles ](#ApiClient.ParameterSetBase.MappingFiles)
  - [A Parameters ](#ApiClient.ParameterSetBase.Parameters)
  - [M Clone ](#ApiClient.ParameterSetBase.Clone)
  - [M GetIndex ](#ApiClient.ParameterSetBase.GetIndex)
  - [M GetLineNo ](#ApiClient.ParameterSetBase.GetLineNo)
  - [M GetName ](#ApiClient.ParameterSetBase.GetName)
  - [M GetPackage ](#ApiClient.ParameterSetBase.GetPackage)
  - [M GetParent ](#ApiClient.ParameterSetBase.GetParent)
  - [M GetTestCaseId ](#ApiClient.ParameterSetBase.GetTestCaseId)
  - [M GetTestScriptId ](#ApiClient.ParameterSetBase.GetTestScriptId)
  - [M GetType ](#ApiClient.ParameterSetBase.GetType)
  - [M IsEnabled ](#ApiClient.ParameterSetBase.IsEnabled)
  - [M IsReported ](#ApiClient.ParameterSetBase.IsReported)
  - [M RemoveFromProject ](#ApiClient.ParameterSetBase.RemoveFromProject)
  - [M SetEnabled ](#ApiClient.ParameterSetBase.SetEnabled)
  - [M SetName ](#ApiClient.ParameterSetBase.SetName)
  - [M SetReported ](#ApiClient.ParameterSetBase.SetReported)
  - [M SetTestCaseId ](#ApiClient.ParameterSetBase.SetTestCaseId)
  - [M GetPosition ](#ApiClient.ParameterSetBase.GetPosition)
...
Return type:  [`ParameterSetBase`](#ApiClient.ParameterSetBase "ApiClient.ParameterSetBase (Python class) — Returns access to the package attributes definitions specified within the parameter set and the referenced package attribute definition files.")

GetIndex()[¶](#ApiClient.ParameterSetBase.GetIndex "Link to this definition")  
...
GetLineNo()[¶](#ApiClient.ParameterSetBase.GetLineNo "Link to this definition")  
...
IsReported()[¶](#ApiClient.ParameterSetBase.IsReported "Link to this definition")  
...
SetEnabled(*[state](#ApiClient.ParameterSetBase.SetEnabled.state "ApiClient.ParameterSetBase.SetEnabled.state (Python parameter) — True (=Default) to enable, False to disable the test step.")=`True`*)[¶](#ApiClient.ParameterSetBase.SetEnabled "Link to this definition")  
Enable or disable the test step.

Parameters:  state : bool[¶](#ApiClient.ParameterSetBase.SetEnabled.state "Permalink to this definition")  
True (=Default) to enable, False to disable the test step.

SetName(*[name](#ApiClient.ParameterSetBase.SetName.name "ApiClient.ParameterSetBase.SetName.name (Python parameter) — Name of the component")*)[¶](#ApiClient.ParameterSetBase.SetName "Link to this definition")  
Sets the name of the project component.

Parameters:  name : str[¶](#ApiClient.ParameterSetBase.SetName.name "Permalink to this definition")  
Name of the component

SetReported(*[state](#ApiClient.ParameterSetBase.SetReported.state "ApiClient.ParameterSetBase.SetReported.state (Python parameter) — True (=Default) to enable, False to disable the reporting of the test step.")=`True`*)[¶](#ApiClient.ParameterSetBase.SetReported "Link to this definition")  
...
Parameters:  state : bool[¶](#ApiClient.ParameterSetBase.SetReported.state "Permalink to this definition")  
True (=Default) to enable, False to disable the reporting of the test step.

SetTestCaseId(*[testCaseId](#ApiClient.ParameterSetBase.SetTestCaseId.testCaseId "ApiClient.ParameterSetBase.SetTestCaseId.testCaseId (Python parameter) — Test case id")*)[¶](#ApiClient.ParameterSetBase.SetTestCaseId "Link to this definition")  
Sets the independent test case id of the parameter record.

Parameters:  testCaseId : str[¶](#ApiClient.ParameterSetBase.SetTestCaseId.testCaseId "Permalink to this definition")  
Test case id
...
Deprecated since version 2024.4: Please use method [`GetLineNo`](#ApiClient.ParameterSetBase.GetLineNo "ApiClient.ParameterSetBase.GetLineNo (Python method) — Returns the line number within its project.") instead.
