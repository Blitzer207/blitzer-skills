...
CurveAllExpectation [ CurveAllExpectation ](#)

CurveAllExpectation

- [C CurveAllExpectation ](#ApiClient.CurveAllExpectation)
  - [M Clone ](#ApiClient.CurveAllExpectation.Clone)
  - [M GetExpectation ](#ApiClient.CurveAllExpectation.GetExpectation)
  - [M GetExpectationExpression ](#ApiClient.CurveAllExpectation.GetExpectationExpression)
  - [M SetExpectation ](#ApiClient.CurveAllExpectation.SetExpectation)
  - [M SetExpectationExpression ](#ApiClient.CurveAllExpectation.SetExpectationExpression)
...
- [`ExpectationApi.CreateCurveAllExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateCurveAllExpectation "ApiClient.ExpectationApi.CreateCurveAllExpectation (Python method) — Creates a curve expectation. All values of the curve have to fulfill the given expectation.")

- [`ExpectationApi.CreateCurveAllExpressionExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateCurveAllExpressionExpectation "ApiClient.ExpectationApi.CreateCurveAllExpressionExpectation (Python method) — Creates a curve expectation. All values of the curve have to fulfill the given expression.")
...
Return type:  [`CurveAllExpectation`](#ApiClient.CurveAllExpectation "ApiClient.CurveAllExpectation (Python class) — Represents an expectation on all elements of a curve. All elements of the curve must fulfill the expectation for this curve expectation to be fulfilled.")
...
SetExpectation(*[expectationObject](#ApiClient.CurveAllExpectation.SetExpectation.expectationObject "ApiClient.CurveAllExpectation.SetExpectation.expectationObject (Python parameter) — The expectation object")*)[¶](#ApiClient.CurveAllExpectation.SetExpectation "Link to this definition")  
Sets the expectation object.

Parameters:  expectationObject[¶](#ApiClient.CurveAllExpectation.SetExpectation.expectationObject "Permalink to this definition")  
The expectation object

SetExpectationExpression(*[expression](#ApiClient.CurveAllExpectation.SetExpectationExpression.expression "ApiClient.CurveAllExpectation.SetExpectationExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.CurveAllExpectation.SetExpectationExpression "Link to this definition")  
Sets the expectation expression.

Parameters:  expression : str[¶](#ApiClient.CurveAllExpectation.SetExpectationExpression.expression "Permalink to this definition")  
The expression
