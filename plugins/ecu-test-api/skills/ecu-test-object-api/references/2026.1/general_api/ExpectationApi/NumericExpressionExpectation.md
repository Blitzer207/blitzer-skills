...
NumericExpressionExpectation [ NumericExpressionExpectation ](#)

NumericExpressionExpectation

- [C NumericExpressionExpectation ](#ApiClient.NumericExpressionExpectation)
  - [M Clone ](#ApiClient.NumericExpressionExpectation.Clone)
  - [M GetExpression ](#ApiClient.NumericExpressionExpectation.GetExpression)
  - [M SetExpression ](#ApiClient.NumericExpressionExpectation.SetExpression)
...
- [`ExpectationApi.CreateNumericExpressionExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateNumericExpressionExpectation "ApiClient.ExpectationApi.CreateNumericExpressionExpectation (Python method) — Creates a manual numeric expectation.")
...
Return type:  [`NumericExpressionExpectation`](#ApiClient.NumericExpressionExpectation "ApiClient.NumericExpressionExpectation (Python class) — ExpectationApi.CreateNumericExpressionExpectation")
...
SetExpression(*[expression](#ApiClient.NumericExpressionExpectation.SetExpression.expression "ApiClient.NumericExpressionExpectation.SetExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.NumericExpressionExpectation.SetExpression "Link to this definition")  
Sets the expectations expression.

Parameters:  expression : str[¶](#ApiClient.NumericExpressionExpectation.SetExpression.expression "Permalink to this definition")  
The expression
