...
BinaryExpressionExpectation [ BinaryExpressionExpectation ](#)

BinaryExpressionExpectation

- [C BinaryExpressionExpectation ](#ApiClient.BinaryExpressionExpectation)
  - [M Clone ](#ApiClient.BinaryExpressionExpectation.Clone)
  - [M GetExpression ](#ApiClient.BinaryExpressionExpectation.GetExpression)
  - [M SetExpression ](#ApiClient.BinaryExpressionExpectation.SetExpression)
...
- [`ExpectationApi.CreateBinaryExpressionExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateBinaryExpressionExpectation "ApiClient.ExpectationApi.CreateBinaryExpressionExpectation (Python method) — Creates a binary expectation to be used in TsEdiabas.")
...
Return type:  [`BinaryExpressionExpectation`](#ApiClient.BinaryExpressionExpectation "ApiClient.BinaryExpressionExpectation (Python class) — ExpectationApi.CreateBinaryExpressionExpectation")
...
SetExpression(*[expression](#ApiClient.BinaryExpressionExpectation.SetExpression.expression "ApiClient.BinaryExpressionExpectation.SetExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.BinaryExpressionExpectation.SetExpression "Link to this definition")  
Sets the expectations expression.

Parameters:  expression : str[¶](#ApiClient.BinaryExpressionExpectation.SetExpression.expression "Permalink to this definition")  
The expression
