...
ExpressionExpectationBase [ ExpressionExpectationBase ](#)

ExpressionExpectationBase

- [C ExpressionExpectationBase ](#ApiClient.ExpressionExpectationBase)
  - [M Clone ](#ApiClient.ExpressionExpectationBase.Clone)
  - [M GetExpression ](#ApiClient.ExpressionExpectationBase.GetExpression)
  - [M SetExpression ](#ApiClient.ExpressionExpectationBase.SetExpression)
...
Return type:  [`ExpressionExpectationBase`](#ApiClient.ExpressionExpectationBase "ApiClient.ExpressionExpectationBase (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
...
SetExpression(*[expression](#ApiClient.ExpressionExpectationBase.SetExpression.expression "ApiClient.ExpressionExpectationBase.SetExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.ExpressionExpectationBase.SetExpression "Link to this definition")  
Sets the expectations expression.

Parameters:  expression : str[¶](#ApiClient.ExpressionExpectationBase.SetExpression.expression "Permalink to this definition")  
The expression
