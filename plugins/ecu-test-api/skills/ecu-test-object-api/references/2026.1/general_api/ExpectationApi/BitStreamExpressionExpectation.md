...
BitStreamExpressionExpectation [ BitStreamExpressionExpectation ](#)

BitStreamExpressionExpectation

- [C BitStreamExpressionExpectation ](#ApiClient.BitStreamExpressionExpectation)
  - [M Clone ](#ApiClient.BitStreamExpressionExpectation.Clone)
  - [M GetExpression ](#ApiClient.BitStreamExpressionExpectation.GetExpression)
  - [M SetExpression ](#ApiClient.BitStreamExpressionExpectation.SetExpression)
...
- [`ExpectationApi.CreateBitStreamExpressionExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateBitStreamExpressionExpectation "ApiClient.ExpectationApi.CreateBitStreamExpressionExpectation (Python method) — Creates a bit stream expression expectation.")
...
Return type:  [`BitStreamExpressionExpectation`](#ApiClient.BitStreamExpressionExpectation "ApiClient.BitStreamExpressionExpectation (Python class) — ExpectationApi.CreateBitStreamExpressionExpectation")
...
SetExpression(*[expression](#ApiClient.BitStreamExpressionExpectation.SetExpression.expression "ApiClient.BitStreamExpressionExpectation.SetExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.BitStreamExpressionExpectation.SetExpression "Link to this definition")  
Sets the expectations expression.

Parameters:  expression : str[¶](#ApiClient.BitStreamExpressionExpectation.SetExpression.expression "Permalink to this definition")  
The expression
