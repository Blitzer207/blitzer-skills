...
ExpressionExpectation [ ExpressionExpectation ](#)

ExpressionExpectation

- [C ExpressionExpectation ](#ApiClient.ExpressionExpectation)
  - [M Clone ](#ApiClient.ExpressionExpectation.Clone)
  - [M GetExpression ](#ApiClient.ExpressionExpectation.GetExpression)
  - [M SetExpression ](#ApiClient.ExpressionExpectation.SetExpression)
...
- [`ExpectationApi.CreateExpressionExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateExpressionExpectation "ApiClient.ExpectationApi.CreateExpressionExpectation (Python method) — Creates an unspecific expression expectation.")
...
Return type:  [`ExpressionExpectation`](#ApiClient.ExpressionExpectation "ApiClient.ExpressionExpectation (Python class) — ExpectationApi.CreateExpressionExpectation")
...
SetExpression(*[expression](#ApiClient.ExpressionExpectation.SetExpression.expression "ApiClient.ExpressionExpectation.SetExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.ExpressionExpectation.SetExpression "Link to this definition")  
Sets the expectations expression.

Parameters:  expression : str[¶](#ApiClient.ExpressionExpectation.SetExpression.expression "Permalink to this definition")  
The expression
