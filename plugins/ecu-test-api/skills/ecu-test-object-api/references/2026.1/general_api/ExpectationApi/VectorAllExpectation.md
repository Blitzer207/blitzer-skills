...
VectorAllExpectation [ VectorAllExpectation ](#)

VectorAllExpectation

- [C VectorAllExpectation ](#ApiClient.VectorAllExpectation)
  - [M Clone ](#ApiClient.VectorAllExpectation.Clone)
  - [M GetExpectation ](#ApiClient.VectorAllExpectation.GetExpectation)
  - [M GetExpectationExpression ](#ApiClient.VectorAllExpectation.GetExpectationExpression)
  - [M SetExpectation ](#ApiClient.VectorAllExpectation.SetExpectation)
  - [M SetExpectationExpression ](#ApiClient.VectorAllExpectation.SetExpectationExpression)
...
- [`ExpectationApi.CreateVectorAllExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateVectorAllExpectation "ApiClient.ExpectationApi.CreateVectorAllExpectation (Python method) — Creates a vector expectation. All values of the vector have to fulfill the given expectation.")

- [`ExpectationApi.CreateVectorAllExpressionExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateVectorAllExpressionExpectation "ApiClient.ExpectationApi.CreateVectorAllExpressionExpectation (Python method) — Creates a vector expectation. All values of the vector have to fulfill the given expression.")
...
Return type:  [`VectorAllExpectation`](#ApiClient.VectorAllExpectation "ApiClient.VectorAllExpectation (Python class) — Represents an expectation on all elements of a vector. All elements of the vector must fulfill the expectation for this vector expectation to be fulfilled.")
...
SetExpectation(*[expectationObject](#ApiClient.VectorAllExpectation.SetExpectation.expectationObject "ApiClient.VectorAllExpectation.SetExpectation.expectationObject (Python parameter) — The expectation object")*)[¶](#ApiClient.VectorAllExpectation.SetExpectation "Link to this definition")  
Sets the expectation object.

Parameters:  expectationObject[¶](#ApiClient.VectorAllExpectation.SetExpectation.expectationObject "Permalink to this definition")  
The expectation object

SetExpectationExpression(*[expression](#ApiClient.VectorAllExpectation.SetExpectationExpression.expression "ApiClient.VectorAllExpectation.SetExpectationExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.VectorAllExpectation.SetExpectationExpression "Link to this definition")  
Sets the expectation expression.

Parameters:  expression : str[¶](#ApiClient.VectorAllExpectation.SetExpectationExpression.expression "Permalink to this definition")  
The expression
