...
- [C Expectation ](#ApiClient.Expectation)
  - [M Clone ](#ApiClient.Expectation.Clone)
...
Return type:  [`Expectation`](#ApiClient.Expectation "ApiClient.Expectation (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
