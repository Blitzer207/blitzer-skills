...
- [C ManualExpression ](#ApiClient.ManualExpression)
  - [M Clone ](#ApiClient.ManualExpression.Clone)
  - [M GetExpression ](#ApiClient.ManualExpression.GetExpression)
  - [M SetExpression ](#ApiClient.ManualExpression.SetExpression)
...
Return type:  [`ManualExpression`](#ApiClient.ManualExpression "ApiClient.ManualExpression (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
...
SetExpression(*[expression](#ApiClient.ManualExpression.SetExpression.expression "ApiClient.ManualExpression.SetExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.ManualExpression.SetExpression "Link to this definition")  
Sets the expectations expression.

Parameters:  expression : str[¶](#ApiClient.ManualExpression.SetExpression.expression "Permalink to this definition")  
The expression
