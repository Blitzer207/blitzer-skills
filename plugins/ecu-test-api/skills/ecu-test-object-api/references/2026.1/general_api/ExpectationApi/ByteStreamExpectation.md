...
- [C ByteStreamExpectation ](#ApiClient.ByteStreamExpectation)
  - [M Clone ](#ApiClient.ByteStreamExpectation.Clone)
  - [M GetExpression ](#ApiClient.ByteStreamExpectation.GetExpression)
  - [M GetMaskExpression ](#ApiClient.ByteStreamExpectation.GetMaskExpression)
  - [M SetExpression ](#ApiClient.ByteStreamExpectation.SetExpression)
  - [M SetMaskExpression ](#ApiClient.ByteStreamExpectation.SetMaskExpression)
...
- [`ExpectationApi.CreateByteStreamExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateByteStreamExpectation "ApiClient.ExpectationApi.CreateByteStreamExpectation (Python method) — Creates a byte stream expectation.")
...
Return type:  [`ByteStreamExpectation`](#ApiClient.ByteStreamExpectation "ApiClient.ByteStreamExpectation (Python class) — ExpectationApi.CreateByteStreamExpectation")
...
SetExpression(*[expression](#ApiClient.ByteStreamExpectation.SetExpression.expression "ApiClient.ByteStreamExpectation.SetExpression.expression (Python parameter) — The expectation expression, e.g.")*)[¶](#ApiClient.ByteStreamExpectation.SetExpression "Link to this definition")  
Sets the expectation expression.

Parameters:  expression : str[¶](#ApiClient.ByteStreamExpectation.SetExpression.expression "Permalink to this definition")  
The expectation expression, e.g. “ByteStream(‘00:00:00:00:00:00:00:00’)”

SetMaskExpression(*[expression](#ApiClient.ByteStreamExpectation.SetMaskExpression.expression "ApiClient.ByteStreamExpectation.SetMaskExpression.expression (Python parameter) — The mask expression, e.g.")*)[¶](#ApiClient.ByteStreamExpectation.SetMaskExpression "Link to this definition")  
Sets the mask expression.

Parameters:  expression : str[¶](#ApiClient.ByteStreamExpectation.SetMaskExpression.expression "Permalink to this definition")  
The mask expression, e.g. “ByteStream(‘FF:FF:FF:FF:FF:FF:FF:FF’)”
