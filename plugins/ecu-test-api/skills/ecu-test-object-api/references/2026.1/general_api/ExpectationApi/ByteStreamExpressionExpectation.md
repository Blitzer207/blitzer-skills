...
ByteStreamExpressionExpectation [ ByteStreamExpressionExpectation ](#)

ByteStreamExpressionExpectation

- [C ByteStreamExpressionExpectation ](#ApiClient.ByteStreamExpressionExpectation)
  - [M Clone ](#ApiClient.ByteStreamExpressionExpectation.Clone)
  - [M GetExpression ](#ApiClient.ByteStreamExpressionExpectation.GetExpression)
  - [M SetExpression ](#ApiClient.ByteStreamExpressionExpectation.SetExpression)
...
- [`ExpectationApi.CreateByteStreamExpressionExpectation`](../ExpectationApi.md#ApiClient.ExpectationApi.CreateByteStreamExpressionExpectation "ApiClient.ExpectationApi.CreateByteStreamExpressionExpectation (Python method) — Creates a byte stream expression expectation.")
...
Return type:  [`ByteStreamExpressionExpectation`](#ApiClient.ByteStreamExpressionExpectation "ApiClient.ByteStreamExpressionExpectation (Python class) — ExpectationApi.CreateByteStreamExpressionExpectation")
...
SetExpression(*[expression](#ApiClient.ByteStreamExpressionExpectation.SetExpression.expression "ApiClient.ByteStreamExpressionExpectation.SetExpression.expression (Python parameter) — The expression")*)[¶](#ApiClient.ByteStreamExpressionExpectation.SetExpression "Link to this definition")  
Sets the expectations expression.

Parameters:  expression : str[¶](#ApiClient.ByteStreamExpressionExpectation.SetExpression.expression "Permalink to this definition")  
The expression
