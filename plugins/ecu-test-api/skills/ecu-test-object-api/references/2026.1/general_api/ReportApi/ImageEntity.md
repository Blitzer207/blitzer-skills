...
- [C ImageEntity ](#ApiClient.ImageEntity)
  - [M Clone ](#ApiClient.ImageEntity.Clone)
  - [M GetImage ](#ApiClient.ImageEntity.GetImage)
  - [M GetType ](#ApiClient.ImageEntity.GetType)
...
Return type:  [`ImageEntity`](#ApiClient.ImageEntity "ApiClient.ImageEntity (Python class) — Represents a single image enbedded within the report details of a report item.")
