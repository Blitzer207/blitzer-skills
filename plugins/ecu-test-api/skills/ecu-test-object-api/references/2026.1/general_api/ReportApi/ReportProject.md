...
- [C ReportProject ](#ApiClient.ReportProject)
  - [M Clone ](#ApiClient.ReportProject.Clone)
  - [M GetAttributes ](#ApiClient.ReportProject.GetAttributes)
  - [M GetComment ](#ApiClient.ReportProject.GetComment)
  - [M GetElementName ](#ApiClient.ReportProject.GetElementName)
  - [M GetProjectElements ](#ApiClient.ReportProject.GetProjectElements)
  - [M GetReportItemId ](#ApiClient.ReportProject.GetReportItemId)
  - [M GetResult ](#ApiClient.ReportProject.GetResult)
  - [M GetType ](#ApiClient.ReportProject.GetType)
...
Return type:  [`ReportProject`](#ApiClient.ReportProject "ApiClient.ReportProject (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
