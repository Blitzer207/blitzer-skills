...
- [C Entity ](#ApiClient.Entity)
  - [M Clone ](#ApiClient.Entity.Clone)
  - [M GetType ](#ApiClient.Entity.GetType)
...
Return type:  [`Entity`](#ApiClient.Entity "ApiClient.Entity (Python class) — An entity is a set of information visible in the report details of a certain reportitem. Each test step, analysis step or project step has specific report details, that are written to the report one after another.")
