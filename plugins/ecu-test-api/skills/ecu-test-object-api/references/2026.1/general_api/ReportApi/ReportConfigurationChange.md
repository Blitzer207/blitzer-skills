...
ReportConfigurationChange [ ReportConfigurationChange ](#)

ReportConfigurationChange

- [C ReportConfigurationChange ](#ApiClient.ReportConfigurationChange)
  - [M Clone ](#ApiClient.ReportConfigurationChange.Clone)
  - [M GetComment ](#ApiClient.ReportConfigurationChange.GetComment)
  - [M GetElementName ](#ApiClient.ReportConfigurationChange.GetElementName)
  - [M GetProjectElements ](#ApiClient.ReportConfigurationChange.GetProjectElements)
  - [M GetReportItemId ](#ApiClient.ReportConfigurationChange.GetReportItemId)
  - [M GetResult ](#ApiClient.ReportConfigurationChange.GetResult)
  - [M GetType ](#ApiClient.ReportConfigurationChange.GetType)
...
Return type:  [`ReportConfigurationChange`](#ApiClient.ReportConfigurationChange "ApiClient.ReportConfigurationChange (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
