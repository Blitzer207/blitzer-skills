...
- [C ReportImage ](#ApiClient.ReportImage)
  - [M Clone ](#ApiClient.ReportImage.Clone)
  - [M GetRelativePath ](#ApiClient.ReportImage.GetRelativePath)
  - [M GetTitle ](#ApiClient.ReportImage.GetTitle)
...
Return type:  [`ReportImage`](#ApiClient.ReportImage "ApiClient.ReportImage (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
