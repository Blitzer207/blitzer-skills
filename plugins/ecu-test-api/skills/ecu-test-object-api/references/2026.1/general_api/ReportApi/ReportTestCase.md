...
- [C ReportTestCase ](#ApiClient.ReportTestCase)
  - [M Clone ](#ApiClient.ReportTestCase.Clone)
  - [M GetResult ](#ApiClient.ReportTestCase.GetResult)
  - [M GetTestSteps ](#ApiClient.ReportTestCase.GetTestSteps)
...
Return type:  [`ReportTestCase`](#ApiClient.ReportTestCase "ApiClient.ReportTestCase (Python class) — Call this method if you want to use API-objects in multiple contexts, e.g. if you want to insert a specific test step in multiple blocks.")
...
Return type:  list[[`ReportTestStep`](ReportTestStep.md#ApiClient.ReportTestStep "ApiClient.ReportTestStep (Python class) — Add a revaluation comment to the test step.")]
