...
Setup IDE [ Setup IDE ](setup_ide.md)
...
We recommend VS Code because no additional setup needs to be done manually and all settings are workspace specific. That allows easy changing of workspaces that may have different flow bundle versions.

To start developing your flow definition, open the unzipped flow bundle as folder in VS Code. The files in the .vscode folder contain the setup for development with the flow.kit and no manual setup step needs to be done. The VS Code setup contains the following elements:

- Python interpreter and environment
- Code snippets for code templates for block insertion
  - just type the name of the block to get the code snippet inserted in your code: ![vscode_ide](res/setup_ide/vscode_ide.png)
- Predefined "Debug Run configurations" for [validation](validate_execute_visualize.md#validate-flow-bundle), [visualization (experimental)](validate_execute_visualize.md#visualize-flow-definition-experimental-feature) and [execution](validate_execute_visualize.md#execute-flow-bundle-locally) of the flow bundle
- For fast feedback: Predefined "Tasks" for [validation](validate_execute_visualize.md#validate-flow-bundle), [visualization (experimental)](validate_execute_visualize.md#visualize-flow-definition-experimental-feature) and [execution](validate_execute_visualize.md#execute-flow-bundle-locally)

## PyCharm

To start developing your flow definition, open the unzipped flow bundle as a folder in PyCharm. The files in the .idea folder contain the setup for run configurations for [validation](validate_execute_visualize.md#validate-flow-bundle), [visualization (experimental)](validate_execute_visualize.md#visualize-flow-definition-experimental-feature) and [execution](validate_execute_visualize.md#execute-flow-bundle-locally) of the flow.

Interpreter setup

In PyCharm, the interpreter is not workspace specific. Thus you need to set the interpreter manually:

1.  Open Settings → Project: ... → Python Interpreter
2.  Press Button: Add Interpreter → Add Local Interpreter
3.  In the dialog:
    1.  Environment: Select Existing
    2.  Type: Python
    3.  Python Path: Choose python.exe in interpreter/ subfolder of the bundle
